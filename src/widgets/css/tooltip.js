...
export const getContentAfter = (props: Object) => {
  const { isPop, fx, placement } = props;
  if (isPop === true) {
    const theBottom = `top: ${em(-1)};
        `;
    const theTop = `bottom: ${em(-1)};
        `;
    const theLeft = `right: ${em(-1)};
        `;
    const theRight = `left: ${em(-1)};`;

    const size =
      fx === 'top' || fx === 'bottom'
        ? `width:${em(12)};height :${em(2)};`
        : `width:${em(2)};height :${em(12)};`;
    let position = '';
    switch (placement) {
      case 'bottomLeft':
        position = `left: ${em(12)};${theBottom}; `;
        break;
      case 'bottom':
        position = `left: 46%;${theBottom}; `;
        break;
      case 'bottomRight':
        position = `right: ${em(12)};${theBottom}; `;
        break;
      case 'topLeft':
        position = `left: ${em(12)};${theTop}; `;
        break;
      case 'top':
        position = `left: 46%;${theTop}; `;
        break;
      case 'topRight':
        position = `right: ${em(12)};${theTop}; `;
        break;
      case 'rightTop':
        position = `top: ${em(12)};${theRight}; `;
        break;
      case 'right':
        position = `top: 46%;${theRight};`;
        break;
      case 'rightBottom':
        position = `bottom: ${em(12)}; ${theRight};`;
        break;
      case 'leftTop':
        position = `top: ${em(12)};${theLeft};`;
        break;
      case 'left':
        position = `top: 46%;${theLeft};`;
        break;
      case 'leftBottom':
        position = ` bottom: ${em(12)}; ${theLeft};`;
        break;
      default:
        break;
    }
