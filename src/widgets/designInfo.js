    ...
    meta: {
      ...
      props: {
        ...
        icons: {
          ...
          desc: '配置前置和后缀图标',
          meta: [
            { key: 'preIconClass', title: '前置图标', type: 'icon' },
            { key: 'preIconSrc', title: '前置图片', type: 'string' },
            { key: 'SuffixIconClass', title: '后缀图标', type: 'icon' },
            { key: 'preIconSrc', title: '后缀图片', type: 'string' },
          ],
        },
      },
      events: {
  ...
  },
  {
    meta: {
      ...
      props: {
        ...
        type: { type: 'InputType', desc: 'input类型', defaultValue: 'text' },
