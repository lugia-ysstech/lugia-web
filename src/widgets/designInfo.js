...
export default [
        ...
        BreadcrumbItem: {
          ...
          theme: {
            ItemWrap: {
              name: '文本',
              desc: '面包屑的文本配置',
              normal: [['width'], ['padding'], ['margin'], ['opacity']],
              hover: [],
              clicked: [],
              disabled: [],
            },
  ...
  },
  {
    meta: {
      ...
      props: {
        ...
        type: { type: 'CardType', desc: '卡片风格 可配置 简洁,头像,图片,组合卡片几种风格' },
        imageOrientation: {
  ...
  },
  {
    meta: {
      ...
      props: {
        ...
        data: { type: 'Object[]', desc: '指定折叠面板data数据源，仅用于设计器', designOnly: true },
      },
      events: {
        onChange: {
      ...
      theme: {
        ...
        Panel: {
          theme: {
            Wrap: { name: '面板整体配置', desc: '面板整体配置', normal: [['width']] },
            PanelHeader: {
              name: '面板头部配置',
              desc: '面板头部样式配置',
              normal: [
  ...
  },
  {
    meta: {
      ...
      props: {
        ...
        placeholder: { type: 'Array<string>', desc: 'input输入提示信息' },
        disabled: { type: 'boolean', desc: '禁用状态,是否不可用', defaultValue: false },
        readOnly: { type: 'boolean', desc: '只读input', defaultValue: false },
        selectToday: { type: 'boolean', desc: '是否默认选中今天日期', defaultValue: false },
        showToday: {
  ...
  },
  {
    meta: {
      ...
      props: {
        viewClass: { type: 'string', desc: '用于配置通用主题属性' },
        iconClass: { type: 'string', desc: '图标资源,需从图标库中获取.' },
      },
      events: {
        onClick: {
          desc: '点击按钮时触发',
  ...
  },
  {
    meta: {
      ...
      props: {
        ...
        data: { type: 'Object', desc: '开关配置的展示信息' },
        size: { type: 'string', desc: '设置开关大小' },
  ...
  },
  {
    meta: {
      ...
      desc: 'Table  表格。',
      props: {
        columns: { type: 'Object[]', desc: '表格每一行展示的内容' },
        data: { type: 'Object[]', desc: '数据源，指定 table 组件的数据' },
  ...
  },
  {
    meta: {
      ...
      props: {
        ...
        data: { type: 'Array<Object>', desc: '配置标签页需要配置的数据,' },
        defaultData: {
          type: 'Array<Object>',
  ...
  },
  {
    meta: {
      ...
      props: {
        ...
        pendingDot: { type: 'React.Node', desc: '当最后一个是幽灵节点时,指定其图标资源' },
        mode: {
          type: 'TimeLineMode',
