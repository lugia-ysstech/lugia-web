...
export default [
  ...
  },
  {
    meta: {
      ...
      desc: '单选框。',
      props: {
        defaultValue: { type: 'string', desc: '单选框初始选中值', defaultValue: 'undefined' },
        value: { type: 'string', desc: '单选框选中值', defaultValue: 'undefined' },
        data: { type: 'Object[]', desc: '单选框信息', defaultValue: 'undefined' },
