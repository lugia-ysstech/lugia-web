...
class InputTag extends React.Component<InputTagProps, InputTagState> {
  ...
  getSwitchIconTheme() {
    ...
    const switchIconTheme = getPartOfThemeConfig('SwitchIcon');
    ...
    switchIconTheme.themeConfig = deepMerge(defaultSwitchIconTheme, switchIconTheme);
    const newSwitchIconTheme = {
      [Widget.Icon]: {
        Icon: switchIconTheme.themeConfig,
      },
    };
    return newSwitchIconTheme;
  }
  getClearIconTheme() {
    const { getPartOfThemeConfig } = this.props;
    const clearIconTheme = getPartOfThemeConfig('ClearIcon');
    ...
    clearIconTheme.themeConfig = deepMerge(defaultClearIcon, clearIconTheme);
    const newClearIconTheme = {
      [Widget.Icon]: {
        Icon: clearIconTheme.themeConfig,
      },
    };
  ...
  getClearButton() {
    ...
    const theme =
      this.isEmpty() || !canClear ? this.getSwitchIconTheme() : this.getClearIconTheme();
    const Icon =
