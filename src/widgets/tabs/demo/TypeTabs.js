  ...
  render() {
    return (
      <div>
        <TabsWrapper>
          <Title>线性风格</Title>
          <Tabs tabType={'line'} pagedType={'single'} data={defaultData} />
        </TabsWrapper>
        <TabsWrapper>
          <Title>分隔线(仅支持线性风格)</Title>
          <Tabs tabType={'line'} pagedType={'single'} showDividerLine={true} data={defaultData} />
        </TabsWrapper>

        <TabsWrapper>
          <Title>卡片风格</Title>
          <Tabs tabType={'card'} pagedType={'single'} data={defaultData} />
        </TabsWrapper>

        <TabsWrapper>
          <Title>窗口风格</Title>
          <Tabs tabType={'window'} pagedType={'page'} data={defaultData} />
        </TabsWrapper>
      </div>
    );
  }
