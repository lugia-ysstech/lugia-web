  ...
  render() {
    ...
    return (
      <div>
        ...
        <Button
          onClick={() =>
            Modal.info({ title: 'info', content: 'this info text!', mountBody: false })
          }
        >
          info
        </Button>
        ...
        <Button
          onClick={() =>
            Modal.success({ title: 'success', content: 'this success text!', mountBody: false })
          }
        >
          success
        </Button>
        ...
        <Button
          onClick={() =>
            Modal.error({ title: 'error', content: 'this error text!', mountBody: false })
          }
        >
          error
        </Button>
        ...
        <Button
          onClick={() =>
            Modal.createShowModal({ title: 'warning', component: Text, mountBody: false })()
          }
        >
          warning
        </Button>
