...
const directionData = [
  ...
  'lugia-icon-direction_center_alignment_new',
  ...
  'lugia-icon-direction_down_circle_new',
...
const finacialData = [
  ...
  'lugia-icon-financial_audit_add',
  'lugia-icon-financial_audit_error',
  'lugia-icon-financial_audit_new',
  'lugia-icon-financial_back_file_new',
  ...
  'lugia-icon-financial_check_all',
  ...
  'lugia-icon-financial_deselection',
  ...
  'lugia-icon-financial_overlay_installation',
  'lugia-icon-financial_page_add',
  'lugia-icon-financial_page_copy',
  'lugia-icon-financial_page_import',
  ...
  'lugia-icon-financial_replace',
  'lugia-icon-financial_resd',
  'lugia-icon-financial_reverse_audit',
