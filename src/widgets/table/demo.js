...
class OldDemo extends React.Component<any, any> {
  ...
  render() {
    ...
    const data_children = [
      ...
      {
        key: '002',
        name: '字节字节字节字节字节字节字节字节字节字节字节字节字节字节字节字节',
        age: '15',
        score: 5,
      },
      {
    ...
    return (
      <div style={{ padding: '20px' }}>
        <br />
        <h1>解决 columns有子列时且有竖向滚动条时，第一行的最后一列不展示border-right问题</h1>
        <Table columns={column_children} data={data_children} scroll={{ y: 100 }} />
