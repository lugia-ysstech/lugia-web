  ...
  render() {
    ...
    return (
      <Fragment>
        ...
        <Window visible={levelVisible} onClose={this.onClose('levelVisible')} middle y={200}>
          <Text>水平居中显示</Text>
          <Text> 垂直200</Text>
        </Window>
        <Window visible={verticalVisible} onClose={this.onClose('verticalVisible')} middle x={200}>
          <Text>垂直居中显示</Text>
          <Text>水平 200</Text>
        </Window>
        <Window visible={middleVisible} onClose={this.onClose('middleVisible')} middle>
          <Text>居中显示</Text>
        </Window>
      </Fragment>
    );
