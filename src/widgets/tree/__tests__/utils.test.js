...
30     4
  */
  ...
  it('value2SelectInfo 配合查询  query: 1.3.1 选择 1  query: 1.3.1.a', () => {
    ...
    let result = utils.value2SelectInfo(selectedInfo.value, expandInfo.id2ExtendInfo);
    exp(result).to.be.eql({
      halfchecked: {},
      checked: {},
      value: {
    ...
    utils.search(expandInfo, '');
    result = utils.value2SelectInfo(selectedInfo.value, expandInfo.id2ExtendInfo);
    exp(result).to.be.eql({
      halfchecked: {
        [getKey('1')]: 5,
        [getKey('1.3')]: 4,
  ...
  it('value2SelectInfo 跨级松散', () => {
    ...
    const result = utils.value2SelectInfo({
      [getKey('1')]: true,
      [getKey('1.3')]: true,
      [getKey('1.3.1')]: true,
      [getKey('1.3.1.1')]: true,
